...
export const onSetLoading = (
  field: ISetLoadingParam['field'],
  value: ISetLoadingParam['value']
...
export const onResetCreateJobState = () =>
  action(CreateJobActionTypes.ON_RESET_STATE, {});
